...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return {
    title: service.name,
    description: `${service.name}: official fee ${formatInr(service.official_fee_inr)} and ${formatDays(
      service.official_timeline_days,
    )} official timeline, compared with what citizens reported. ${service.description}`.slice(0, 300),
